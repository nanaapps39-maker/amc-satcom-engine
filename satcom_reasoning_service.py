# ================================================================
# REBUILD TRIGGER — 2026-09-07 Deployment v27 
...
# ======================================================
# FUTURE TRENDS ENDPOINT
# ======================================================

class FutureTrendsRequest(BaseModel):
    years: int | str
    domain: str

@app.post("/future-trends")
def future_trends(req: FutureTrendsRequest):
    engine = FutureTrendsEngine()
    return engine.predict_any(req.years, req.domain)
